...
use cairo_vm::{
    any_box,
    hint_processor::hint_processor_definition::{HintReference, HintProcessorLogic},
    stdlib::{boxed::Box, collections::HashMap, prelude::*},
    stdlib::str::from_utf8,
    types::{relocatable::{MaybeRelocatable, Relocatable}, errors::math_errors::MathError, exec_scope::ExecutionScopes},
    vm::{runners::cairo_runner::{ResourceTracker, RunResources}, errors::{vm_errors::VirtualMachineError, hint_errors::HintError}},
    vm::vm_core::VirtualMachine,
    Felt252,
    serde::deserialize_program::ApTracking,
};
use super::dict_manager::DictSquashExecScope;
    ...
    pub fn execute(
        ...
        match hint {
            ...
            Hint::Starknet(StarknetHint::Cheatcode { selector, .. }) => {
                ...
                let selector = from_utf8(selector).map_err(|_| {
